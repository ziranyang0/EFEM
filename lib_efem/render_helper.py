...
node = platform.node()
if 'microsoft-standard' in uname().release.lower():
    os.environ["PYOPENGL_PLATFORM"] = "osmesa" # WSL test
elif node == "endurance":  # my mobile workstation
    os.environ["PYOPENGL_PLATFORM"] = "egl"
else:  # somehow the cluster has some nodes whose EGL is working ...
    os.environ["PYOPENGL_PLATFORM"] = "egl"
import pyrender
...
if __name__ == "__main__":
    ...
    render(pcl_list=[pcl], pcl_color_list=[(1, 0, 0)], pcl_radius_list=[0.1])
